    ...
    return (
        <>
            ...
            <main className="flex gap-4 bg-bgPrimary px-[150px] py-10">
                <Sidebar />
                <section className=" rounded-xl bg-white w-3/4 p-8 shadow-xl min-h-[778px] relative">
                    ...
                    <div className="mt-8 flex flex-col gap-5">
                        {userList.data?.map(data => {
                            return (
                                <div className="flex justify-start items-center gap-5 cursor-pointer shadow-[0_4px_20px_rgba(0,0,0,0.1)] p-5 rounded-xl" key={data.id} onClick={() => router.push(`/transfer/${data.id}`)}>
                                    ...
                                    <div className="flex flex-col items-start">
                                        <p className="font-bold text-lg text-dark text-center">{data.firstName} {data.lastName}</p>
                    ...
                    <div className="absolute bottom-5 flex justify-center items-center gap-2 left-1/2 -translate-x-1/2">
