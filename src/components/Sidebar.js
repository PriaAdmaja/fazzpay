...
const Sidebar = () => {
    ...
    return (
        <aside className="rounded-xl bg-white py-6 md:py-12 w-full md:w-1/3 lg:w-1/4 flex md:flex-col items-start gap-5 sm:gap-10 shadow-xl justify-around md:justify-center">
            <div className={`${showTopup ? 'border-none' : router.pathname.split('/')[1] === 'dashboard' ? 'border-none border-l-4 md:border-solid border-l-primary' : 'border-none'} flex justify-start items-center gap-6 px-4 sm:px-8 cursor-pointer`} onClick={() => router.push('/dashboard')}>
            ...
            <div className={`${showTopup ? 'border-none' : router.pathname.split('/')[1] === 'transfer' ? 'border-none border-l-4 md:border-solid border-l-primary' : 'border-none'} cursor-pointer flex justify-start items-center gap-6 px-4 sm:px-8`} onClick={() => router.push('/transfer')}>
            ...
            <div className={`${showTopup ? 'border-none border-l-4 md:border-solid border-l-primary' : 'border-none'} cursor-pointer flex justify-start items-center gap-6 px-4 sm:px-8`} onClick={topupHandler}>
            ...
            <div className={`${showTopup ? 'border-none' : router.pathname.split('/')[1] === 'profile' ? 'border-none border-l-4 md:border-solid border-l-primary' : 'border-none'} flex justify-start items-center gap-6 px-4 sm:px-8 cursor-pointer`} onClick={() => router.push('/profile')}>
            ...
            <div className={`hidden md:flex border-none justify-start items-center gap-6 px-4 sm:px-8 mt-auto cursor-pointer`} onClick={logout}>
