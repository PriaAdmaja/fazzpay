    ...
    return (
        <header className="py-[50px] px-[150px] flex shadow-lg rounded-2xl items-center select-none relative z-10">
            ...
            <div className="flex justify-center items-center gap-8 relative">
                ...
                <div className={`${showNotif ? 'flex' : 'hidden'} absolute  w-[320px] rounded-xl top-32 right-0 p-5 bg-white flex-col gap-5 shadow-xl`}>
                    {notif.map((data, i) => {
                        ...
                        return (
                            <div key={i} className="flex gap-4 py-5 px-6 bg-white rounded-lg shadow-lg">
                                ...
                                <div>
                                    ...
                                    <p className="text-[#43484F] text-lg font-semibold">Rp{data.amount}</p>
                                </div>
                            </div>
                        )
                    })}
